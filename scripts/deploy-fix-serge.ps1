# deploy-fix-serge.ps1
#
# Uploads fix-serge-pronostics.cjs to /app on the Fly.io machine and runs it.
#
# Usage (from repo root):
#   .\scripts\deploy-fix-serge.ps1
...
$localScript = Join-Path $PSScriptRoot 'fix-serge-pronostics.cjs'
$remotePath  = '/app/fix-serge-pronostics.cjs'
