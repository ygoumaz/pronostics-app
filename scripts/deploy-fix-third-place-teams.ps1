# deploy-fix-third-place-teams.ps1
#
# Uploads fix-third-place-teams.cjs to /app on the Fly.io machine and runs it.
# Backfills the team codes for the third-place match (M103), which never got
# populated due to a propagation bug (see comment header in the .cjs script).
#
# Usage (from repo root):
#   .\scripts\deploy-fix-third-place-teams.ps1
...
$localScript = Join-Path $PSScriptRoot 'fix-third-place-teams.cjs'
$remotePath  = '/app/fix-third-place-teams.cjs'
