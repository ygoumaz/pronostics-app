# deploy-fix-tomgoat-match84.ps1
#
# Uploads fix-tomgoat-match84.cjs to /app on the Fly.io machine and runs it.
#
# Usage (from repo root):
#   .\scripts\deploy-fix-tomgoat-match84.ps1
...
$localScript = Join-Path $PSScriptRoot 'fix-tomgoat-match84.cjs'
$remotePath  = '/app/fix-tomgoat-match84.cjs'
