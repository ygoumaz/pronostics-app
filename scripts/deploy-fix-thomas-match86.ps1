# deploy-fix-thomas-match86.ps1
#
# Uploads fix-thomas-match86.cjs to /app on the Fly.io machine and runs it.
#
# Usage (from repo root):
#   .\scripts\deploy-fix-thomas-match86.ps1
...
$localScript = Join-Path $PSScriptRoot 'fix-thomas-match86.cjs'
$remotePath  = '/app/fix-thomas-match86.cjs'
